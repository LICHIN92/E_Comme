...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    Bookings();
  }, [id, token, refresh, returnback,review]);
  ...
  return (
    <>
      {review && <Review setReview={setReview} file={file} />}
      ...
      <div className='profile'>
        <div className='userprofile'>
          ...
          <div className='flex flex-col ps-7 my-2 text-wrap'>
                ...
                <div className='usedbookedDetails'>
                  {bookdata.map((file, index) => (
                    <div className='bookedDetail' key={index}>
                      ...
                      {(file.delivery && !file.review) &&
                        <button className='text-green-900 fw-bold bg-green-300 px-1' onClick={() =>reviwing(file)} >
                          Review
                        </button>
                      }
