  ...
  return (
    ...
    >
      ...
      {/* {image.map((item, index) => (
        ...
        <div className="carousel-item ">
          <img src='https://images.unsplash.com/photo-1524275406383-49f669cf763a?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' className="d-block w-100 items-center" alt="Second slide" />
        </div>
        <div className="carousel-item">
        ...
        <div className="carousel-item">
          <img  className="d-block w-100" src="https://images.unsplash.com/photo-1610189000544-1f0885c4bbeb?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
        </div>
        <div className="carousel-item">
          <img className="d-block w-100" src="https://images.unsplash.com/photo-1692559002378-d5cf7a78fd89?q=80&w=1535&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
        </div>
      </div>
      <button
